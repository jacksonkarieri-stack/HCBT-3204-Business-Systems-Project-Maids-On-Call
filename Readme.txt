...
3. Create a database with the name mhmsdb

4. Import mhmsdb.sql file(given inside the zip package in the SQL file folder)

5. Run the script http://localhost/moc
